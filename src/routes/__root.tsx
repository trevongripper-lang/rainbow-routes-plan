...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Pitch destinations, upvote together, chatter about plans, and discover regional queer events." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Tribe Trips — Plan gay vacations with your crew" },
      { name: "twitter:description", content: "Pitch destinations, upvote together, chatter about plans, and discover regional queer events." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fc2c7643-f6eb-448a-832a-3c3ad272c237/id-preview-c58854ee--938ee2e4-e28c-4f9a-80fb-c8ac6ff9fb0b.lovable.app-1781065518657.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fc2c7643-f6eb-448a-832a-3c3ad272c237/id-preview-c58854ee--938ee2e4-e28c-4f9a-80fb-c8ac6ff9fb0b.lovable.app-1781065518657.png" },
